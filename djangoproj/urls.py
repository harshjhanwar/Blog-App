...
urlpatterns = [
    ...
    path('user_logout/', user_views.logout_user, name='user_logout'),
    path('profile_update/', user_views.profile_update, name='user-profile_update'),
    path('login/', auth_views.LoginView.as_view(template_name='user/login.html'), name='user-login'),
    path('logout/', auth_views.LogoutView.as_view(template_name='user/logout.html'), name='user-logout'),
    path('password_reset/', auth_views.PasswordResetView.as_view(template_name='user/password_reset.html'), name='reset_password'),
